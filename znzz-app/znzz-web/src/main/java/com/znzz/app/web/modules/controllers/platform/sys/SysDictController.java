...
//    }
    ...
    public Object data(@Param("length") int length, @Param("start") int start, @Param("draw") int draw, @Param("::order") List<DataTableOrder> order, @Param("::columns") List<DataTableColumn> columns) {
        ...
        return dictService.data(length, start, draw, order, columns, Cnd.where("parentId", "=", "").or("parentId", "is", null), null);
    }
    ...
    public Object initDict(){
    	//返回数据字典数据
    	//Map<String, Map<String, String>> map = Globals.DictMap; 
    	List<Sys_dict> dictList = dictService.dao().query(Sys_dict.class,null);
    	return dictList;
    }
}
