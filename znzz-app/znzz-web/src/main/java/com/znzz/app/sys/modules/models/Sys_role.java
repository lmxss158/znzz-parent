...
public class Sys_role extends BaseModel implements Serializable {
    ...
    @ManyMany(from = "roleId", relation = "sys_role_unit", to = "unitId")
    ...
    public List<Sys_unit> getUnits() {    return units; }

    public void setUnits(List<Sys_unit> units) { this.units = units;}
