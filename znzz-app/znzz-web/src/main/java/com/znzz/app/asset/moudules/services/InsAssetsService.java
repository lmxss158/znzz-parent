 ...
 */
public interface InsAssetsService extends BaseService<Ins_Assets>{
	 ...
	 * @return
	 */
	NutMap getAssetsDataWith(AssetsForm assets, int length, int start, int draw, List<DataTableOrder> order,
	...
	List<AssetsForm> getExportList(AssetsForm assetsForm);
	 ...
	 * @return
	 */
	XSSFWorkbook exportAssetsInfo(String[] ids, HttpServletRequest request, HttpServletResponse response,
	 ...
	 * @return
	 */
	AssetsForm getAssetAndRuleInfoDetail(Integer id,String assetCode);
	 ...
	 * @return
	 */
	boolean getAssetCode(String assetCode);
	 ...
	 * @return
	 */
	Map<String,Ins_Assets> getAssetAndRuleInfoByAssetCodes(String assetCode);
	 ...
	 * @return
	 */
	Ins_Assets getInsAssetBean(String assetCode);
	 ...
	 * @return
	 */
	boolean existDeviceVersion(String deviceVersion);

    void unUsed(Integer[] ids, String message);

	void forbidden(Integer[] ids, String message);
	 ...
	 * @return
	 */
    NutMap getImportInfo(List<ExcelImportResult<Ins_Assets>> assetsImportFile, String saveOrUpdate,String userId);

	void updateList(List<Ins_Assets> assetsList);
}
